...
import { ResourceSchedule } from "@/components/calendar/resource-schedule";
  ...
  return (
    <div className="h-screen flex flex-col bg-background text-foreground">
      <Navbar
        ...
        subtitle="Track equipment, rooms, and personnel allocation"
      />
      ...
      <div className="flex-1 overflow-hidden">
        ...
        >
          <ResourceSchedule date={new Date()} />
        </CalendarProvider>
      </div>
    </div>
  );
